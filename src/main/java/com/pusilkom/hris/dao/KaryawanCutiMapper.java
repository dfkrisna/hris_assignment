...
public interface KaryawanCutiMapper {
    ...
    @Select("SELECT CK.id, CK.id_karyawan, CK.nama_lengkap, CK.jumlah_hari, CK.periode_mulai, CK.periode_selesai, CK.is_disetujui, CK.is_tolak\n" +
            "FROM \n" +
    ...
    @Select("SELECT C.id, K.nama_lengkap, C.id_karyawan, C.jumlah_hari, C.periode_mulai, C.periode_selesai, C.is_disetujui, C.is_tolak\n" +
